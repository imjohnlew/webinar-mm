...
const FunnelTemplate = ({ title, description, stages, revenueData, revenueSummary, stickyTopPx = 0 }) => {
    ...
    return (
        <div className="w-full flex flex-col gap-6 pb-8">
            ...
            {/* ── STICKY HEADER: title + toggle + stage selector when in detail view ── */}
            <div
                className="sticky z-20 bg-[#0f172a]/95 backdrop-blur-sm border-b border-slate-800/60
                           -mx-4 px-4 md:-mx-6 md:px-6 lg:-mx-8 lg:px-8 pt-6 pb-4"
            ...
            >
                ...
                {/* Stage selector — only in detail view */}
                {!funnelView && (
                    <div className="flex items-center gap-1 overflow-x-auto pt-4 pb-1">
                        {stages.map((s, i) => (
