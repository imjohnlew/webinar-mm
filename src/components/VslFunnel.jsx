...
const VslAdMockup = () => (
    <div className="bg-white rounded-lg overflow-hidden shadow-sm border border-slate-200 text-[9px] text-slate-700">
        ...
        <div className="px-2.5 pb-1.5 space-y-1">
            <div className="font-bold text-slate-800 text-[8px]">Discover The [Result] System That's Helped [X] People [Achieve Outcome]</div>
        ...
        <div className="w-full aspect-video bg-gradient-to-br from-slate-700 to-slate-900 flex flex-col items-center justify-center gap-1 relative">
            <div className="absolute top-1.5 left-1.5 bg-red-500 text-white text-[7px] font-black px-1.5 py-0.5 rounded">▶ WATCH VIDEO</div>
            <div className="w-10 h-10 rounded-full bg-white/20 flex items-center justify-center">
                <Play className="w-5 h-5 text-white fill-white ml-0.5" />
            </div>
            <div className="text-white font-black text-[9px] text-center px-3">[Your Compelling Hook Here]</div>
        </div>
        <div className="bg-slate-50 border-t border-slate-200 px-2.5 py-2 flex items-center justify-between">
            <div><div className="text-[7px] text-slate-400">yoursite.com</div><Bar w="w-24" h="h-1.5" color="bg-slate-300" className="mt-0.5" /></div>
            <div className="bg-blue-600 text-white text-[7px] font-bold px-2.5 py-1 rounded">Watch Now</div>
        </div>
        <div className="px-2.5 py-1.5 flex items-center justify-between border-t border-slate-100">
            <div className="flex items-center gap-0.5 text-[7px] text-slate-400"><span>👍❤️😮</span><span className="ml-0.5">3.1k</span></div>
...
const VslPageMockup = () => (
    <div className="bg-white text-[9px] text-slate-700">
        <div className="bg-slate-900 px-3 py-1.5 flex items-center justify-between">
            ...
            <div className="text-[7px] text-yellow-400 font-bold flex items-center gap-0.5"><Clock className="w-2 h-2" /> Offer expires in 47:32</div>
        </div>
        <div className="p-3 space-y-2.5">
            ...
            <div className="text-[8px] text-slate-500 text-center">Watch the video below to see exactly how it works</div>
            {/* VSL Video */}
            <div className="w-full aspect-video bg-slate-800 rounded-lg flex items-center justify-center relative overflow-hidden">
                <div className="absolute inset-0 bg-gradient-to-br from-slate-700 to-slate-900" />
                <div className="relative flex flex-col items-center gap-1">
                    <div className="w-9 h-9 rounded-full bg-white/20 flex items-center justify-center">
                        <Play className="w-4 h-4 text-white fill-white ml-0.5" />
                    </div>
                    <div className="text-[7px] text-slate-300 font-bold">Click to play (47 min)</div>
                </div>
                {/* Progress bar */}
                <div className="absolute bottom-1.5 left-2 right-2 h-1 bg-slate-600 rounded-full">
                    <div className="w-0 h-full bg-red-500 rounded-full" />
                </div>
            </div>
            {/* Buy button (appears after video) */}
            <div className="bg-yellow-50 border-2 border-yellow-400 rounded-lg p-2 text-center space-y-1">
                <div className="text-[7px] text-yellow-700 font-bold">⚡ Button unlocks after watching</div>
                <div className="w-full bg-orange-500 text-white font-black text-[9px] py-2 rounded opacity-50">
                    YES — I Want [Outcome] Now →
                </div>
            </div>
            {/* Bullets below video */}
            <div className="space-y-1 pt-1">
                <div className="font-bold text-[8px] text-slate-700">In this training you'll discover:</div>
            ...
            <div className="border border-slate-200 rounded-lg p-2 bg-slate-50">
                <div className="text-[7px] text-slate-500 italic">"[Specific result] in [timeframe]. I couldn't believe it worked so fast."</div>
                <div className="text-[7px] font-bold text-slate-700 mt-0.5">— [Name], [Title/Location]</div>
            </div>
        </div>
    </div>
);
...
const VslOrderMockup = () => (
    <div className="bg-white text-[9px] text-slate-700">
        ...
        <div className="p-3 space-y-2">
            <div className="font-black text-center text-[10px]">🔒 Complete Your Order</div>
            <div className="bg-orange-50 border border-orange-200 rounded p-2 text-center">
                <div className="text-[7px] text-orange-700 font-bold">⏱ Price increases when timer hits zero</div>
                <div className="text-[10px] font-black text-orange-600">47:18</div>
            </div>
            ...
            <div className="text-center">
                <div className="text-[8px] text-slate-500 line-through">$297</div>
                <div className="text-2xl font-black text-slate-900">$47</div>
                <div className="text-[7px] text-slate-500">One-time · Instant access</div>
            </div>
            <div className="w-full bg-orange-500 text-white font-black text-[10px] py-2 rounded text-center">Get Instant Access →</div>
            <div className="flex items-center justify-center gap-1 text-[7px] text-slate-400"><Shield className="w-2 h-2" /> SSL Secured · 60-Day Money Back</div>
        </div>
    </div>
);
...
const VslUpsellMockup = () => (
    <div className="bg-white text-[9px] text-slate-700">
        <div className="bg-orange-500 px-3 py-2 text-center">
            <div className="text-white font-black text-[9px]">⚡ WAIT — Your order is processing!</div>
            <div className="text-orange-100 text-[7px]">Read this before going to your receipt</div>
        </div>
        <div className="p-3 space-y-2">
            ...
            <div className="text-[7px] text-slate-500 text-center font-bold">This is a ONE-TIME offer. It disappears when you leave this page.</div>
            ...
            <div className="w-full bg-orange-500 text-white font-black text-[9px] py-2 rounded text-center">YES! Add This For +$97 →</div>
            <div className="text-center text-[7px] text-slate-400 underline cursor-pointer">No thanks, I'll figure it out on my own</div>
        </div>
    </div>
);
...
const VslDownsellMockup = () => (
    <div className="bg-white text-[9px] text-slate-700">
        <div className="bg-slate-700 px-3 py-2 text-center">
            <div className="text-white font-black text-[9px]">Wait — One More Thing Before You Go</div>
        </div>
        <div className="p-3 space-y-2">
            <div className="text-[8px] text-slate-500 text-center">I understand $97 might not be right for you right now...</div>
            <div className="font-black text-slate-900 text-[10px] text-center leading-tight">
            ...
            <div className="w-full bg-slate-800 text-white font-black text-[9px] py-2 rounded text-center">Yes — Give Me The Lite Version</div>
            <div className="text-center text-[7px] text-slate-400 underline cursor-pointer">No thanks, I'll pass on this too</div>
        </div>
    </div>
);
...
const VslTYMockup = () => (
    <div className="bg-white text-[9px] text-slate-700">
        ...
        <div className="p-3 space-y-2">
            <div className="text-[8px] text-slate-700 text-center">Check your email for your receipt and login details.</div>
            <div className="w-full bg-green-500 text-white font-black text-[9px] py-2 rounded text-center">Access [Product Name] Now →</div>
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-2 text-center space-y-1">
                <div className="text-[8px] font-bold text-blue-700">Ready to go deeper?</div>
